"""Strategy: Mean-Reversion Composite Alpha.

4-layer composite with regime filter, vol-parity sizing and an IC signal
stability guard. The trivial 1-period reversal that used to live here is now
``specs/simple_mean_reversion.yaml``.
"""
